...
export default function SocialAccountCard({
  ...
  return (
    <div
      ...
      className={`relative rounded-2xl backdrop-blur-xl p-4 sm:p-6 flex flex-row sm:flex-col items-center gap-3 sm:gap-3 cursor-pointer select-none border transition-all duration-200 ease-in-out min-h-[44px] ${
        isSelected
    ...
    >
      ...
      <div className="flex flex-col sm:items-center min-w-0">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400 sm:text-center truncate">
          {subtext}
        </p>
      </div>
    </div>
